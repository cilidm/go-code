...
> Original link: [https://studygolang.com/articles/35042](https://studygolang.com/articles/35042)
...
* [talks.golang.org/2014/names.…](https://talks.golang.org/2014/names.slide)
* [golang.org/doc/effecti…](https://golang.org/doc/effective\_go.html#names)
* [blog.golang.org/package-nam…](https://blog.golang.org/package-names)
* [github.com/golang/go/w…](https://github.com/golang/go/wiki/CodeReviewComments)
...
有关示例，请参阅 [`/cmd`](https://studygolang.com/articles/cmd/README.md) 目录。
...
如果你想查看哪个流行的 Go 存储库使用此项目布局模式，请查看 [`/pkg`](https://studygolang.com/articles/pkg/README.md) 目录。这是一种常见的布局模式，但并不是所有人都接受它，一些 Go 社区的人也不推荐它。
...
有关示例，请参见 [`/api`](https://studygolang.com/articles/api/README.md) 目录。
...
有关示例，请参见 [`/scripts`](https://studygolang.com/articles/scripts/README.md) 目录。
...
有关示例，请参见 [`/test`](https://studygolang.com/articles/test/README.md) 目录。
...
有关示例，请参阅 [`/docs`](https://studygolang.com/articles/docs/README.md) 目录。

#### `/tools`

这个项目的支持工具。注意，这些工具可以从 `/pkg` 和 `/internal` 目录导入代码。

有关示例，请参见 [`/tools`](https://studygolang.com/articles/tools/README.md) 目录。

#### `/examples`

你的应用程序和/或公共库的示例。

有关示例，请参见 [`/examples`](https://studygolang.com/articles/examples/README.md) 目录。
...
有关示例，请参见 [`/website`](https://studygolang.com/articles/website/README.md) 目录。
